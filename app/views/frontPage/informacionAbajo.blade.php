<div class="row">
	<div class="alert alert-success alert-dismissable">
		...
		<span class="glyphicon glyphicon-thumbs-up"></span> Ni&ntilde;
		os <strong>hasta 4 a&ntilde;
		os</strong> Pasean gratis.
	</div>
</div>
<div class="row">
	<div class="alert alert-danger">
		...
		n al  Servicio del Catamar&aacute;
		n, el Club ha decidido cobrar a nuestros usuarios en la puerta del Club,  las siguientes cantidades:
	</div>
...
<div class="row">
	<div class="panel-group" id="accordion">
		<div class="panel panel-default">
			...
			<div id="temporadaAlta" class="panel-collapse collapse in">
		...
		<div class="panel panel-default">
			...
			<div id="temporadaBaja" class="panel-collapse collapse">
				<div class="panel-body">
					<ol>
						<li>
							Adultos: de 12 a 60 años, Bs.
