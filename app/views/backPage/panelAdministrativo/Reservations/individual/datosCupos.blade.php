<div class="panel panel-info Cupos">
	...
	<div class="panel-body">
		<div class="input-group">
			...
			{{  Form::input('number', 'adults', $Reservacion->adults,array('class'=>'phone form-control')) }}
		</div>
		<div class="input-group">
			<div class="input-group-addon">
			...
			{{  Form::input('number', 'olders', $Reservacion->olders,array('class'=>'phone form-control')) }}
		</div>
		<div class="input-group">
			<div class="input-group-addon">
			...
			{{  Form::input('number', 'childs', $Reservacion->childs,array('class'=>'phone form-control')) }}
		</div>
		<div class="input-group">
			<div class="input-group-addon">
...
<?php $activo         = ($Reservacion->trashed())?true:false;
