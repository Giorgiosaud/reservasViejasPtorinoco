...
(function($) {
	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				case 'alert':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" class="btn btn-primary" id="popup_ok" /></div>');
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '"class="btn btn-primary" id="popup_ok" /> <input type="button" value="' + $.alerts.cancelButton + '" class="btn btn-primary" id="popup_cancel" /></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
				...
				break;
				case 'prompt':
					$("#popup_message").append('<br /><input type="text" size="30" id="popup_prompt" />').after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" class="btn btn-primary" id="popup_ok" /> <input type="button" value="' + $.alerts.cancelButton + '" class="btn btn-primary" id="popup_cancel" /></div>');
